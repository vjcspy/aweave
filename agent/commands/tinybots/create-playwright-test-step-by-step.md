...
- `PACKAGE_ROOT`: Folder containing the Playwright project (example: `workspaces/devtools/tinybots/playwright`)
- `BASE_URL`: Target URL (example: `https://dashadmin.tinybots.academy`)
- `TEST_FILE`: Target spec to create/update (example: `workspaces/devtools/tinybots/playwright/tests/academy.login.spec.ts`)
