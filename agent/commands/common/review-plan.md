...
- `PLAN_PATH`: Path to the plan markdown file (e.g., `resources/workspaces/<ws>/<domain>/<repo>/_plans/YYMMDD-Title.md` or any `*.md` plan path)
...
If `{PLAN_PATH}` matches `resources/workspaces/<WS>/<DOMAIN>/<REPO>/...`:
 
1. Read global overview: `resources/workspaces/<WS>/OVERVIEW.md`
2. Read repo overview: `resources/workspaces/<WS>/<DOMAIN>/<REPO>/OVERVIEW.md`
