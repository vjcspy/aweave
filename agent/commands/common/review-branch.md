...
```
agent/skills/common/code-review/SKILL.md
```
...
|----------|----------|---------|-------------|---------|
| `REPO_PATH` | ✅ | - | Path to repo relative to workspace root | `workspaces/nab/hod/ho-omh-customer-loan-mods-web` |
...
1. **LOAD the skill first** - `agent/skills/common/code-review/SKILL.md`
...
If `REPO_PATH` follows pattern `workspaces/<PROJECT>/<DOMAIN>/<REPO>`:

1. Check for: `resources/workspaces/<PROJECT>/OVERVIEW.md`
2. Check for: `resources/workspaces/<PROJECT>/<DOMAIN>/<REPO>/OVERVIEW.md`
3. Load if exists for architecture/conventions context

### Step 3.2: Execute Review Using Skill

**Follow the workflow in `agent/skills/common/code-review/SKILL.md`:**
...
# Phase 3-4: Review
# → Follow: agent/skills/common/code-review/SKILL.md
```
...
| User Says | Extract |
|-----------|---------|
| "review `workspaces/nab/hod/ho-omh-customer-loan-mods-web` branch `feature/E62181-new-mhl`" | REPO_PATH=`workspaces/nab/hod/ho-omh-customer-loan-mods-web`, FEATURE_BRANCH=`feature/E62181-new-mhl` |
...
| "quick review `workspaces/foo/bar` `feat/x`" | REVIEW_SCOPE=`quick` |
...
1. **Repository path:** What is the full path? (e.g., `workspaces/nab/hod/ho-omh-customer-loan-mods-web`)
...
```
Review branch `feature/E62181-new-mhl` in `workspaces/nab/hod/ho-omh-customer-loan-mods-web`
```

### Full

```
Review branch `feature/E62181-new-manage-home-loan` in `workspaces/nab/hod/ho-omh-customer-loan-mods-web` against `main`, do a deep review
```

### With Context

```
Review the implementation on `feature/E62181-new-mhl` in `workspaces/nab/hod/ho-omh-customer-loan-mods-web`. 
