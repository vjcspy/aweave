...
**Reference implementation:** `workspaces/devtools/common/cli-plugin-demo-workflow/` (run with `aw demo`)
**Design document:** `resources/workspaces/devtools/common/_plans/260208-workflow-engine.md`
...
```
workspaces/devtools/common/cli-plugin-<name>/
├── package.json
├── tsconfig.json
├── eslint.config.mjs
└── src/
...
2. Add to `workspaces/devtools/common/cli/package.json` — both `dependencies` and `oclif.plugins`
