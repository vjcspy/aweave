...
cd workspaces/devtools/common/cli-plugin-dashboard && pnpm build

# Test via root CLI
cd workspaces/devtools/common/cli && node bin/run.js dashboard --help
cd workspaces/devtools/common/cli && node bin/run.js dashboard services --format json
...
```bash
cd workspaces/devtools/common/cli-plugin-dashboard
...
- **Root CLI:** `workspaces/devtools/common/cli/` — `resources/workspaces/devtools/common/cli/OVERVIEW.md`
- **CLI Shared:** `workspaces/devtools/common/cli-shared/` — provides `checkHealth()` reused via `createRequire`
- **Debate Plugin:** `workspaces/devtools/common/cli-plugin-debate/` — CJS plugin pattern reference
- **Implementation Plan:** `resources/workspaces/devtools/common/_plans/260207-cli-plugin-dashboard-ink.md`
