...
- **Debate Spec:** `resources/workspaces/devtools/common/_plans/debate.md` (section 2.1 — states & transitions)
- **CLI Plugin:** `workspaces/devtools/common/cli-plugin-debate/`
- **NestJS Module:** `workspaces/devtools/common/nestjs-debate/`
- **Migration Plan:** `resources/workspaces/devtools/common/_plans/260207-xstate-debate-machine.md`
