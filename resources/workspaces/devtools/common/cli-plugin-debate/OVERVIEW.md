...
```bash
cd workspaces/devtools/common/cli-plugin-debate
...
- **State Machine:** `workspaces/devtools/common/debate-machine/` — shared xstate definition
- **NestJS Backend:** `workspaces/devtools/common/nestjs-debate/`
- **Backend Overview:** `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md`
...
- **xstate Migration Plan:** `resources/workspaces/devtools/common/_plans/260207-xstate-debate-machine.md`
