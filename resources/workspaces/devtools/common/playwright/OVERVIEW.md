...
```bash
cd workspaces/devtools/common/playwright
...
- **Implementation Plan:** `resources/workspaces/devtools/common/_plans/260209-shared-playwright-package.md`
- **CLI Shared (same pattern):** `workspaces/devtools/common/cli-shared/`
- **CLI Shared Overview:** `resources/workspaces/devtools/common/cli-shared/OVERVIEW.md`
