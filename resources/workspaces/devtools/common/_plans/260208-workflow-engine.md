...
- Debate machine (xstate reference): `resources/workspaces/devtools/common/debate-machine/OVERVIEW.md`
- Dashboard plugin (Ink reference): `resources/workspaces/devtools/common/cli-plugin-dashboard/OVERVIEW.md`
- Dashboard Ink plan: `resources/workspaces/devtools/common/_plans/260207-cli-plugin-dashboard-ink.md`
...
- Workflow builder skill: `agent/skills/common/workflow-builder/SKILL.md`
...
|---------|--------|----------|
| `@hod/aweave-workflow-engine` | ✅ Implemented (CJS) | `workspaces/devtools/common/workflow-engine/` |
| `@hod/aweave-workflow-dashboard` | ✅ Implemented (ESM) | `workspaces/devtools/common/workflow-dashboard/` |
| `@hod/aweave-plugin-demo-workflow` | ✅ Implemented (ESM) | `workspaces/devtools/common/cli-plugin-demo-workflow/` |
