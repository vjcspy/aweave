...
- CLI oclif refactor plan: `resources/workspaces/devtools/common/_plans/260207-cli-oclif-refactor.md`
- CLI plugin debate OVERVIEW: `resources/workspaces/devtools/common/cli-plugin-debate/OVERVIEW.md`
- Current state machine: `workspaces/devtools/common/nestjs-debate/src/state-machine.ts`
- Current types: `workspaces/devtools/common/nestjs-debate/src/types.ts`
- CLI plugin debate: `workspaces/devtools/common/cli-plugin-debate/`
...
- [x] Create directory `workspaces/devtools/common/debate-machine/`
- [x] Create `workspaces/devtools/common/debate-machine/package.json`
  - **Outcome**: Package installable via pnpm workspace
- [x] Create `workspaces/devtools/common/debate-machine/tsconfig.json`:
  ```json
  {
    "compilerOptions": {
      "module": "commonjs",
...
- [x] Create `workspaces/devtools/common/debate-machine/src/types.ts` — core types (see Spec section 2)
...
- [x] Create `workspaces/devtools/common/debate-machine/src/machine.ts` — xstate machine (see Spec section 1)
  ...
  - **Outcome**: Declarative state machine matching current transition table from `resources/workspaces/devtools/common/_plans/debate.md` section 2.1.2
- [x] Create `workspaces/devtools/common/debate-machine/src/utils.ts` — utility functions (see Spec section 3)
...
- [x] Create `workspaces/devtools/common/debate-machine/src/index.ts` — barrel export:
  ```typescript
  ...
  ```
- [x] Update `workspaces/devtools/pnpm-workspace.yaml` — add `common/debate-machine`
- [x] Run `cd workspaces/devtools && pnpm install` to link workspace package
- [x] Run `cd workspaces/devtools/common/debate-machine && pnpm build` to verify compilation
...
- [x] Full workspace rebuild: `cd workspaces/devtools && pnpm -r build` — all 9 packages build successfully
...
- [x] Update `resources/workspaces/devtools/common/cli-plugin-debate/OVERVIEW.md` — added debate-machine dep, updated approach section
- [x] Update `resources/workspaces/devtools/common/_plans/debate.md` — updated data flow and components sections
- [x] Create `resources/workspaces/devtools/common/debate-machine/OVERVIEW.md` — full package documentation
