...
- `resources/workspaces/devtools/OVERVIEW.md` — Global devtools overview
- `resources/workspaces/devtools/common/cli/OVERVIEW.md` — oclif CLI entrypoint
- `resources/workspaces/devtools/common/cli-plugin-debate/OVERVIEW.md` — Existing plugin pattern reference
- `workspaces/devtools/common/cli/package.json` — Root CLI oclif config
...
- [x] **GATE: Verify `@hod/aweave-cli-shared` ESM import from ESM plugin**
  - **Steps:**
    1. Build `cli-shared` (`pnpm build` in `workspaces/devtools/common/cli-shared`)
...
- [x] Create `workspaces/devtools/common/cli-plugin-dashboard/package.json`:
  ```json
  {
...
- [x] Add to `workspaces/devtools/pnpm-workspace.yaml`: `common/cli-plugin-dashboard`
- [x] Add to `workspaces/devtools/common/cli/package.json`:
