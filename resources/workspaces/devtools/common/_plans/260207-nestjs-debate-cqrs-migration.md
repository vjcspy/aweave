...
- `resources/workspaces/devtools/OVERVIEW.md` — DevTools global overview
- `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md` — Current debate module overview
- `resources/workspaces/devtools/common/_plans/Server-side Action-driven Architecture.md` — Original action-driven architecture proposal (superseded by this plan)
- `workspaces/devtools/common/nestjs-debate/src/debate.module.ts` — Current module definition
- `workspaces/devtools/common/nestjs-debate/src/debate.controller.ts` — Current controller
- `workspaces/devtools/common/nestjs-debate/src/debate.service.ts` — Current debate service (reads + writes)
- `workspaces/devtools/common/nestjs-debate/src/argument.service.ts` — Current argument service (writes + WS broadcast)
- `workspaces/devtools/common/nestjs-debate/src/debate.gateway.ts` — Current WebSocket gateway
- `workspaces/devtools/common/nestjs-debate/src/types.ts` — Current type definitions
- `workspaces/devtools/common/server/src/main.ts` — Server bootstrap (logger config goes here)
- `workspaces/devtools/common/server/src/app.module.ts` — Root module (LoggerModule import)
...
- [ ] Install pino stack in `@hod/aweave-server` (server-wide)
  - **Command**: `cd workspaces/devtools/common/server && pnpm add nestjs-pino pino-http && pnpm add -D pino-pretty`
...
- [ ] Install `@nestjs/cqrs` dependency in `@hod/aweave-nestjs-debate`
  - **Command**: `cd workspaces/devtools/common/nestjs-debate && pnpm add @nestjs/cqrs`
...
- [ ] Install `nestjs-pino` in `@hod/aweave-nestjs-debate` (for `PinoLogger` injectable in CQRS middleware)
  - **Command**: `cd workspaces/devtools/common/nestjs-debate && pnpm add nestjs-pino`
...
##### 1.1 — Pino configuration (`workspaces/devtools/common/server/src/shared/logger/pino.config.ts`)
...
##### 1.2 — Wire pino into server (`workspaces/devtools/common/server/src/app.module.ts`)
...
##### 1.3 — Use pino as NestJS logger (`workspaces/devtools/common/server/src/main.ts`)
...
- [ ] Build passes: `cd workspaces/devtools/common/nestjs-debate && pnpm build`
- [ ] Server build passes: `cd workspaces/devtools/common/server && pnpm build`
- [ ] Server starts: `cd workspaces/devtools/common/server && pnpm start:dev`
...
- [ ] **OVERVIEW updates** — After migration, update:
  - `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md` — New architecture, CQRS patterns
  - `resources/workspaces/devtools/common/server/OVERVIEW.md` — Pino logger configuration
  - `resources/workspaces/devtools/OVERVIEW.md` — Add logging section to global overview
