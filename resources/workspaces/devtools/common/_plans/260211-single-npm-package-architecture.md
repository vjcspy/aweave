...
- `resources/workspaces/devtools/common/cli/OVERVIEW.md` — CLI entrypoint overview
- `resources/workspaces/devtools/common/server/OVERVIEW.md` — NestJS server overview
- `resources/workspaces/devtools/common/debate-web/OVERVIEW.md` — debate-web overview
- `devtools/ecosystem.config.cjs` — Current PM2 config
- `workspaces/devtools/package.json` — Workspace root
- `workspaces/devtools/pnpm-workspace.yaml` — Workspace packages
- `workspaces/devtools/common/cli/package.json` — CLI oclif config
- `workspaces/devtools/common/server/package.json` — NestJS server dependencies
- `workspaces/devtools/common/debate-web/package.json` — debate-web dependencies
...
- [x] **2.1** Install `@nestjs/serve-static` trong `@hod/aweave-server`
  - `pnpm add @nestjs/serve-static` trong `workspaces/devtools/common/server/`
...
- [x] **3.4** Tạo oclif plugin `@hod/aweave-plugin-server`
  ...
  ```
  workspaces/devtools/common/cli-plugin-server/
...
- [x] **3.5** Register plugin trong CLI
  ...
  - Add to `workspaces/devtools/pnpm-workspace.yaml`
...
- [x] **3.8** Cleanup PM2 artifacts
  ...
  - Remove PM2 scripts từ `workspaces/devtools/package.json` (`start`, `stop`, `logs`)
...
- [x] **4.1** Fix package naming
  - `workspaces/devtools/common/server/package.json`: đổi `"name": "server"` → `"name": "@hod/aweave-server"`
  - `workspaces/devtools/common/debate-web/package.json`: đổi `"name": "debate-web"` → `"name": "@hod/aweave-debate-web"`
...
- [x] **4.3** Tạo build script: `workspaces/devtools/scripts/build-release.sh`
  - **Location:** `workspaces/devtools/scripts/build-release.sh` — chạy từ `devtools/` working directory
...
- [x] **4.6** Tạo npm scripts trong `workspaces/devtools/package.json`
...
- [x] **5.1** Cập nhật `resources/workspaces/devtools/OVERVIEW.md`
...
- [x] **5.2** Cập nhật `resources/workspaces/devtools/common/server/OVERVIEW.md`
  - Thêm `@nestjs/serve-static` config
  - Thêm static file serving documentation
  - Remove PM2 references
  - **Outcome**: Server docs accurate

- [x] **5.3** Cập nhật `resources/workspaces/devtools/common/debate-web/OVERVIEW.md`
