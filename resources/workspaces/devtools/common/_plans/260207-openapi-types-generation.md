...
- **NestJS module:** `workspaces/devtools/common/nestjs-debate/`
- **NestJS module OVERVIEW:** `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md`
- **Server:** `workspaces/devtools/common/server/`
- **Server OVERVIEW:** `resources/workspaces/devtools/common/server/OVERVIEW.md`
- **Client:** `workspaces/devtools/common/debate-web/`
- **Client OVERVIEW:** `resources/workspaces/devtools/common/debate-web/OVERVIEW.md`
...
**Files:** `workspaces/devtools/common/nestjs-debate/src/debate.service.ts`, `workspaces/devtools/common/nestjs-debate/src/argument.service.ts`
...
**Files:** New `workspaces/devtools/common/nestjs-debate/src/dto/` directory
...
**File:** `workspaces/devtools/common/nestjs-debate/src/ws-types.ts`
...
```typescript
// Add to workspaces/devtools/common/nestjs-debate/src/index.ts
...
**File:** `workspaces/devtools/common/nestjs-debate/src/debate.controller.ts`
...
**File:** `workspaces/devtools/common/server/package.json`

```bash
cd workspaces/devtools/common/server
pnpm add @nestjs/swagger
```

**File:** `workspaces/devtools/common/server/src/main.ts`
...
**File:** `workspaces/devtools/common/server/src/scripts/generate-openapi.ts`
...
**Add to `workspaces/devtools/common/server/package.json` scripts:**

```json
"generate:openapi": "ts-node -r tsconfig-paths/register src/scripts/generate-openapi.ts"
```

> **Run from server root:** `cd workspaces/devtools/common/server && pnpm generate:openapi` — writes `openapi.json` to CWD.
...
**File:** `workspaces/devtools/common/debate-web/package.json`

```bash
cd workspaces/devtools/common/debate-web
...
This produces `workspaces/devtools/common/debate-web/lib/api-types.ts` with full typed `paths` and `components.schemas`.

---

#### Step 8: Replace Client API Layer

**File:** `workspaces/devtools/common/debate-web/lib/api.ts`
...
**File:** `workspaces/devtools/common/debate-web/lib/types.ts`
...
**File:** `workspaces/devtools/common/debate-web/hooks/use-debates-list.ts`
...
**File:** `workspaces/devtools/common/debate-web/hooks/use-debate.ts`
...
- `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md` — Add DTO section, WS types section, export list update
- `resources/workspaces/devtools/common/debate-web/OVERVIEW.md` — Add OpenAPI types generation section, update lib structure
- `resources/workspaces/devtools/common/server/OVERVIEW.md` — Add Swagger/OpenAPI generation section
...
**New files:**
- `workspaces/devtools/common/nestjs-debate/src/dto/debate.dto.ts`
- `workspaces/devtools/common/nestjs-debate/src/dto/argument.dto.ts`
- `workspaces/devtools/common/nestjs-debate/src/dto/request.dto.ts`
- `workspaces/devtools/common/nestjs-debate/src/dto/response.dto.ts`
- `workspaces/devtools/common/nestjs-debate/src/dto/error.dto.ts`
- `workspaces/devtools/common/nestjs-debate/src/dto/index.ts`
- `workspaces/devtools/common/nestjs-debate/src/ws-types.ts`
- `workspaces/devtools/common/server/src/scripts/generate-openapi.ts`
- `workspaces/devtools/common/server/openapi.json` (generated)
- `workspaces/devtools/common/debate-web/lib/api-types.ts` (generated)

**Modified files:**
- `workspaces/devtools/common/nestjs-debate/src/debate.service.ts` — serialize before WS broadcast
- `workspaces/devtools/common/nestjs-debate/src/argument.service.ts` — serialize before WS broadcast
- `workspaces/devtools/common/nestjs-debate/src/debate.controller.ts` — Swagger decorators + DTO body types
- `workspaces/devtools/common/nestjs-debate/src/index.ts` — export DTOs + WS types
- `workspaces/devtools/common/nestjs-debate/package.json` — added `@nestjs/swagger`
- `workspaces/devtools/common/server/src/main.ts` — SwaggerModule setup
- `workspaces/devtools/common/server/package.json` — added `@nestjs/swagger` + `generate:openapi` script
- `workspaces/devtools/common/debate-web/lib/api.ts` — openapi-fetch typed client
- `workspaces/devtools/common/debate-web/lib/types.ts` — WS types only, references generated entity types
- `workspaces/devtools/common/debate-web/hooks/use-debate.ts` — import from `@/lib/api`
- `workspaces/devtools/common/debate-web/hooks/use-debates-list.ts` — import from `@/lib/api`, `data.debates`
- `workspaces/devtools/common/debate-web/package.json` — added `openapi-fetch`, `openapi-typescript`, scripts
- `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md`
