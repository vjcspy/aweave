...
- DevTools monorepo: `resources/workspaces/devtools/OVERVIEW.md`
- CLI shared library pattern: `workspaces/devtools/common/cli-shared/`
- Current playwright consumer: `devtools/nab/plugin-nab-auth/src/lib/browser-auth.ts`
- pnpm workspace config: `workspaces/devtools/pnpm-workspace.yaml`
...
Tạo shared package `@hod/aweave-playwright` tại `workspaces/devtools/common/playwright/`. Package này:
...
- [ ] Tạo folder `workspaces/devtools/common/playwright/`
- [ ] Follow conventions từ `workspaces/devtools/common/cli-shared/`
...
- [ ] Tạo `workspaces/devtools/common/playwright/package.json`
...
- [ ] Copy từ `workspaces/devtools/common/cli-shared/tsconfig.json` (cùng config: commonjs, ES2023, strict, declaration)

#### 1.4 — `eslint.config.mjs`

- [ ] Copy từ `workspaces/devtools/common/cli-shared/eslint.config.mjs`
...
- [ ] Thêm `common/playwright` vào `workspaces/devtools/pnpm-workspace.yaml`
...
- [ ] `cd workspaces/devtools/common/playwright && pnpm build`
...
- [ ] Cập nhật `resources/workspaces/devtools/OVERVIEW.md` — thêm `@hod/aweave-playwright` vào dependency graph documentation
