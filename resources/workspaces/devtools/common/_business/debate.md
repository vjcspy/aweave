...
Sử dụng framework OCLIF. Code nằm tại `workspaces/devtools/common/cli` và `workspaces/devtools/common/cli-plugin-debate`.
...
File: `workspaces/devtools/common/nestjs-debate/prisma/schema.prisma`
...
Node.js server unified tại `workspaces/devtools/common/server`.
