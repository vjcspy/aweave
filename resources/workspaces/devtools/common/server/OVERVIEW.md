...
- **OpenAPI spec generation:** `pnpm generate:openapi` runs a standalone script that boots the app, generates `openapi.json`, and writes it to `workspaces/devtools/common/server/openapi.json`
...
1. **Tạo package** tại `workspaces/devtools/<domain>/nestjs-<feature>/` (hoặc `workspaces/devtools/common/nestjs-<feature>/`)
2. **Export** NestJS module từ package: `export { MyFeatureModule } from './my-feature.module'`
3. **Add dependency** trong `workspaces/devtools/common/server/package.json`:
   ```json
...
4. **Import** trong `app.module.ts`:
   ...
   ```
5. **Update** `workspaces/devtools/pnpm-workspace.yaml` to include the new package path
...
- **Debate Feature Module:** `workspaces/devtools/common/nestjs-debate/`
- **Debate Module Overview:** `resources/workspaces/devtools/common/nestjs-debate/OVERVIEW.md`
- **Debate CLI Plugin:** `workspaces/devtools/common/cli-plugin-debate/`
- **Debate CLI Plugin Overview:** `resources/workspaces/devtools/common/cli-plugin-debate/OVERVIEW.md`
- **Debate Web (frontend):** `workspaces/devtools/common/debate-web/`
- **Architecture Plan:** `resources/workspaces/devtools/common/_plans/260207-unified-nestjs-server.md`
