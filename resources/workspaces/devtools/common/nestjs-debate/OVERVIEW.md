...
```typescript
// workspaces/devtools/common/nestjs-debate/src/index.ts
...
Xem plan: `resources/workspaces/devtools/common/_plans/260207-auto-ruling-on-resolution.md`
...
- **Debate Web:** `workspaces/devtools/common/debate-web/`
