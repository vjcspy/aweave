...
```bash
cd workspaces/devtools/common/workflow-dashboard
...
- **Demo Workflow:** `workspaces/devtools/common/cli-plugin-demo-workflow/` — `resources/workspaces/devtools/common/cli-plugin-demo-workflow/OVERVIEW.md`
- **Dashboard Plugin (existing, similar):** `resources/workspaces/devtools/common/cli-plugin-dashboard/OVERVIEW.md`
