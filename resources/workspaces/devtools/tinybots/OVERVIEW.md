...
**→ [agent/commands/tinybots/create-just-commands.md](agent/commands/tinybots/create-just-commands.md)**
...
- **[AGENTS.md](AGENTS.md)** - TinyBots engineering protocols and AI agent guidelines
- **[resources/workspaces/tinybots/OVERVIEW.md](../../tinybots/OVERVIEW.md)** - Global TinyBots project overview
...
1. **Single Source of Truth:** All service definitions live in `workspaces/devtools/tinybots/local/docker-compose.yaml`, not scattered across repos.
