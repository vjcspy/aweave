...
- Hướng dẫn: [resources/workspaces/devtools/tinybots/OVERVIEW.md](resources/workspaces/devtools/tinybots/OVERVIEW.md)
- Template: [agent/templates/common/create-plan.md](../../agent/templates/common/create-plan.md)
- CI Config: [atlas/ci/docker-compose.yml](../../../atlas/ci/docker-compose.yml)
- CI Test Script: [atlas/ci/test.sh](../../../atlas/ci/test.sh)
- Main Justfile: [workspaces/devtools/tinybots/local/Justfile](../../../workspaces/devtools/tinybots/local/Justfile)

## 🎯 Objective

Tích hợp Atlas repository vào hệ thống centralized testing infrastructure của devtools bằng cách:
1. Thêm service definition cho Atlas vào `workspaces/devtools/tinybots/local/docker-compose.yaml`
2. Tạo file `workspaces/devtools/tinybots/local/justfiles/atlas.just` với các commands: `start-atlas`, `test-atlas`, `log-atlas`
...
#### File Structure
```text
workspaces/devtools/tinybots/local/
...
```yaml
  atlas:
    ...
    volumes:
      - tinybots/backend/atlas:/usr/src/app
    labels:
      - "atlas-service"
    environment:
...
#### Step 3.2: Create workspaces/devtools/tinybots/local/justfiles/atlas.just
...
- Consider documenting intelligence service trong resources/workspaces/devtools/tinybots/OVERVIEW.md sau khi implement
