...
- Source requirements: `resources/workspaces/tinybots/azi-3-status-check-jobs/251122-refactor.md` (original user requirements)
- Repository OVERVIEW: `resources/workspaces/tinybots/azi-3-status-check-jobs/OVERVIEW.md`
- Global TinyBots standard: `resources/workspaces/tinybots/OVERVIEW.md`
- Template reference: `agent/TEMPLATE.md`
...
- `resources/workspaces/tinybots/azi-3-status-check-jobs/OVERVIEW.md`:
