  ...
  sections:
    ...
    - key: "fix_plan_option_a"
      ...
      last_sync:
        ...
        remote_hash: ""
  context_files:
    - "resources/workspaces/tinybots/backend/wonkers-nedap/Nedap-retrieve-concepts-flow.md"
    - "resources/workspaces/tinybots/backend/wonkers-nedap/_plans/260213-fix-use-client-address-null-answer.md"
---
...
- `workspaces/tinybots/backend/wonkers-nedap/src/mappers/ConceptOrderMapper.ts:217`
- `workspaces/tinybots/backend/wonkers-nedap/src/mappers/ConceptOrderMapper.ts:245`
- `workspaces/tinybots/backend/wonkers-nedap/src/mappers/ConceptReturnMapper.ts:199`
- `workspaces/tinybots/backend/wonkers-nedap/src/mappers/mapSurvey.ts:87`
- `workspaces/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:64`
- `workspaces/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:84`
- `workspaces/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:153`
- `workspaces/tinybots/backend/wonkers-nedap/src/service/ConceptService.ts:166`
- `resources/workspaces/tinybots/backend/wonkers-nedap/Nedap-retrieve-concepts-flow.md`
- `resources/workspaces/tinybots/backend/wonkers-nedap/_plans/260213-fix-use-client-address-null-answer.md`
