...
- Repo-specific standard: `resources/workspaces/tinybots/wonkers-nedap/OVERVIEW.md`
...
**Command:** `just -f workspaces/devtools/tinybots/local/Justfile test-wonkers-nedap`
