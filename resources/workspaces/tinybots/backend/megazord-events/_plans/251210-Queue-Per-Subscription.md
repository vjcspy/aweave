...
- `tinybots/backend/megazord-events/src/services/EventSubscriptionService.ts` - Main subscription service handling event fan-out
- `tinybots/backend/megazord-events/src/models/DTOs/CreateSubscriptionDto.ts` - Subscription creation DTO
- `tinybots/backend/megazord-events/src/models/domains/SubscriptionDomain.ts` - Subscription domain model
- `tinybots/backend/megazord-events/src/models/SQSConfig.ts` - SQS configuration models
- `tinybots/backend/azi-3-status-check-jobs/config/custom-environment-variables.json` - Jobs consumer configuration
- `tinybots/backend/tiny-internal-services/lib/services/EventService.ts` - Shared library event service
- `resources/workspaces/tinybots/OVERVIEW.md` - Global TinyBots architecture
- `resources/workspaces/tinybots/backend/megazord-events/OVERVIEW.md` - Megazord events service documentation
...
**File:** `tinybots/backend/megazord-events/src/models/DTOs/CreateSubscriptionDto.ts`
...
**File:** `tinybots/backend/megazord-events/src/services/EventSubscriptionService.ts`
...
**File:** `tinybots/backend/azi-3-status-check-jobs/src/infrastructure/MegazordEventClient.ts`
...
**File:** `tinybots/backend/azi-3-status-check-jobs/src/services/MonitoringScheduler.ts`
...
**File:** `tinybots/backend/azi-3-status-check-jobs/config/default.json`
...
1. **workspaces/devtools/tinybots/local/docker-compose.yaml** - Update queue environment variables:
...
**File:** `resources/workspaces/tinybots/backend/megazord-events/OVERVIEW.md`
