...
- `megazord-events/resources/workspaces/tinybots/megazord-events/OVERVIEW.md` - Repository documentation
...
**File:** `resources/workspaces/tinybots/megazord-events/OVERVIEW.md`
