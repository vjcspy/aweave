...
- `resources/workspaces/tinybots/OVERVIEW.md`
- `resources/workspaces/tinybots/backend/tiny-specs/OVERVIEW.md`
- `agent/commands/tinybots/update-tiny-specs.md`
- `resources/workspaces/tinybots/backend/m-o-triggers/251103-trigger-configuration.md`
- `resources/workspaces/tinybots/backend/m-o-triggers/251107-update-setting-column-implement-plan.md`
- `resources/workspaces/tinybots/backend/m-o-triggers/251129-Get-Active-Trigger-Settings.md`
- `workspaces/tinybots/backend/m-o-triggers/src/cmd/app/main.ts`
- `workspaces/tinybots/backend/m-o-triggers/src/controllers/EventTriggerSettingsController.ts`
- `workspaces/tinybots/backend/m-o-triggers/src/models/dtos/UpsertTriggerSettingDto.ts`
- `workspaces/tinybots/backend/m-o-triggers/src/models/domains/EventTriggerDomain.ts`
- `workspaces/tinybots/backend/m-o-triggers/test/controllers/EventTriggerSettingControllerIT.ts`
- `workspaces/tinybots/backend/tiny-specs/src/main.ts`
- `workspaces/tinybots/backend/tiny-specs/specs/local/micro-manager-main.yaml`
...
`resources/workspaces/tinybots/backend/m-o-triggers/251107-update-setting-column-implement-plan.md`
`resources/workspaces/tinybots/backend/m-o-triggers/251129-Get-Active-Trigger-Settings.md`
Now we need to create api spec in `workspaces/tinybots/backend/tiny-specs`
Give me a plan to do it
```

## Objective

Create and publish OpenAPI contract files in `workspaces/tinybots/backend/tiny-specs` for the implemented `m-o-triggers` trigger-setting endpoints so downstream consumers can generate types and validators from a stable spec.
...
- [x] Evaluate existing test structures and define test cases
  - **Outcome**:
    - Contract reference source: `workspaces/tinybots/backend/m-o-triggers/test/controllers/EventTriggerSettingControllerIT.ts`
...
```
workspaces/tinybots/backend/tiny-specs/
...
workspaces/tinybots/backend/m-o-triggers/
...
- [x] Step 2: Add m-o-triggers OpenAPI component schemas
  - Create `workspaces/tinybots/backend/tiny-specs/specs/local/components/m-o-triggers/v1/schemas.yaml`.
...
- [x] Step 3: Add m-o-triggers OpenAPI paths
  - Create `workspaces/tinybots/backend/tiny-specs/specs/local/paths/m-o-triggers/v1/paths.yaml`.
...
- [x] Step 4: Add service main file and refs
  - Create `workspaces/tinybots/backend/tiny-specs/specs/local/m-o-triggers-main.yaml`.
...
- [x] Step 5: Register generator target
  - Update `workspaces/tinybots/backend/tiny-specs/src/main.ts` to include `m-o-triggers-main.yaml` in the correct output target.
  - Decision gate:
...
- [x] Step 6: Build and validate tiny-specs
  - Run `yarn run all` in `workspaces/tinybots/backend/tiny-specs`.
...
- Ran `yarn run all` in `workspaces/tinybots/backend/tiny-specs` with successful compile and generated output updates.
...
- Contract baseline was taken from:
  ...
  - `workspaces/tinybots/backend/m-o-triggers/test/controllers/EventTriggerSettingControllerIT.ts`
- New files created:
  - `workspaces/tinybots/backend/tiny-specs/specs/local/m-o-triggers-main.yaml`
  - `workspaces/tinybots/backend/tiny-specs/specs/local/components/m-o-triggers/v1/schemas.yaml`
  - `workspaces/tinybots/backend/tiny-specs/specs/local/paths/m-o-triggers/v1/paths.yaml`
- Generator registration added:
  - `workspaces/tinybots/backend/tiny-specs/src/main.ts` (`dashboardSchemas`)
...
- Verification:
  - `yarn run all` completed successfully in `workspaces/tinybots/backend/tiny-specs`, and generated dashboard typings/validators include `DayOfWeek`, `EventTriggerSetting`, and `UpsertTriggerSettingRequest`.
