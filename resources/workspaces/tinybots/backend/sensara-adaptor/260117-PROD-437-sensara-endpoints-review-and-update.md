...
- **Repo Overview:** `resources/workspaces/tinybots/sensara-adaptor/OVERVIEW.md`
...
- [ ] **6.1** Run full test suite: `just -f workspaces/devtools/tinybots/local/Justfile test-sensara-adaptor`
- [ ] **6.2** Ensure lint/typecheck pass
- [ ] **6.3** Update `resources/workspaces/tinybots/sensara-adaptor/OVERVIEW.md` with new endpoints
