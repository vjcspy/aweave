...
- [megazord-events OVERVIEW](resources/workspaces/tinybots/backend/megazord-events/OVERVIEW.md)
- [sensara-adaptor OVERVIEW](resources/workspaces/tinybots/backend/sensara-adaptor/OVERVIEW.md)
- [Similar Implementation Plan: PROD591 Add New Event Type](resources/workspaces/tinybots/backend/megazord-events/251112-PROD591-add-new-event-type.md)
- [TinybotsEvent enum](tinybots/backend/tiny-internal-services/lib/model/events/TinybotsEvent.ts)
- [SensaraNotificationType enum (shared)](tinybots/backend/tiny-internal-services/lib/model/sensara/SensaraNotificationDto.ts)
- [SensaraNotificationType enum (local)](tinybots/backend/sensara-adaptor/src/model/sensara/NotificationResponse.ts)
- [Event Schema Generator](tinybots/backend/megazord-events/schemas/gen.ts)
- [SensaraEventsJob](tinybots/backend/sensara-adaptor/src/jobs/SensaraEventsJob.ts)
...
|------------|-------------|--------|------|
| `LastLocationResponse` | Real-time location updates from sensors | ❌ Not implemented | [260107-Streaming-Location-Events.md](resources/workspaces/tinybots/backend/sensara-adaptor/260107-Streaming-Location-Events.md) |
...
5. **Testing**: All tests must run in Docker via `just -f workspaces/devtools/tinybots/local/Justfile test-sensara-adaptor`
...
```bash
cd tinybots/backend/tiny-internal-services
...
```bash
cd tinybots/backend/sensara-adaptor
...
just -f workspaces/devtools/tinybots/local/Justfile test-megazord-events
```
