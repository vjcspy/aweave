...
- `workspaces/tinybots/backend/sensara-adaptor/src/repository/ResidentRepository.ts`
...
4) Run:
   - `yarn build`
   - `yarn lint`
   - (nếu môi trường devtools ổn) `just -f workspaces/devtools/tinybots/local/Justfile test-sensara-adaptor`
