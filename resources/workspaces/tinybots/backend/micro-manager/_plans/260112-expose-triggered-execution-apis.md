...
- **Previous Plan**: `resources/workspaces/tinybots/micro-manager/251206-store-trigger-script.md`
- **Related Services**:
...
| `workspaces/devtools/tinybots/local/docker-compose.yaml` | Mounted V101 migration | ✅ Done |
...
**Note**: For local Docker testing, the migration file is mounted in `workspaces/devtools/tinybots/local/docker-compose.yaml`.
