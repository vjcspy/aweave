...
- Standards:
  - [resources/workspaces/tinybots/OVERVIEW.md](../OVERVIEW.md)
  - [resources/workspaces/tinybots/wonkers-graphql/OVERVIEW.md](./OVERVIEW.md)
...
1. **Database Schema Confirmed** (✅ Verified from `workspaces/devtools/tinybots/local/prisma/dashboard/schema.prisma`):
...
- [x] ✅ **Investigate Prisma schema for field mappings**
  - **Schema Confirmed** from `workspaces/devtools/tinybots/local/prisma/dashboard/schema.prisma`:
    ```prisma
    model taas_order {
      id                  Int                            @id
