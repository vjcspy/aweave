...
- **Original Implementation Plan:** `resources/workspaces/tinybots/backend/wonkers-graphql/251223-Sensara-Events-GraphQL.md`
- **Folder Restructure:** `resources/workspaces/tinybots/backend/wonkers-graphql/260120-Schema-Folder-Restructure.md`
- **Repository Standard:** `resources/workspaces/tinybots/backend/wonkers-graphql/OVERVIEW.md`
...
- [ ] Run unit tests
  ```bash
  just -f workspaces/devtools/tinybots/local/Justfile test-wonkers-graphql
  ```
