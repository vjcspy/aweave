...
- Repo-specific standard: `resources/workspaces/tinybots/wonkers-graphql/OVERVIEW.md`
...
- [ ] Document changes
  - **Update:** `resources/workspaces/tinybots/wonkers-graphql/OVERVIEW.md` with PHI removal information
