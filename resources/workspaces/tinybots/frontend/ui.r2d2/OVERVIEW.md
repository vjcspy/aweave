...
```
workspaces/tinybots/frontend/ui.r2d2/
```
...
```bash
cd workspaces/tinybots/frontend/ui.r2d2
...
- **Backend APIs:** Individual service overviews in `resources/workspaces/tinybots/backend/`
- **OpenAPI Specs:** `resources/workspaces/tinybots/backend/tiny-specs/OVERVIEW.md`
