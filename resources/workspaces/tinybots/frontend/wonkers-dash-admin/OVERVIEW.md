...
- **Customer Dashboard (ui.r2d2):** `resources/workspaces/tinybots/frontend/ui.r2d2/OVERVIEW.md`
- **Backend TaaS Orders:** `resources/workspaces/tinybots/backend/wonkers-taas-orders/OVERVIEW.md`
- **Backend Admin APIs:** `resources/workspaces/tinybots/backend/wonkers-api/OVERVIEW.md`
