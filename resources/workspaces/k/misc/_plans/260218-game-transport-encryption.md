...
**Changes to Vercel Relay (`workspaces/k/misc/git-relay-vercel/`):**
...
**Changes to Server (`workspaces/k/misc/git-relay-server/`):**
...
**Server — `workspaces/k/misc/git-relay-server/src/services/crypto.ts`**
...
**`workspaces/k/misc/git-relay-server/src/routes/data.ts`** (NEW — from patches.ts)
...
**`workspaces/k/misc/git-relay-server/src/routes/gr.ts`** (NEW)
...
**`workspaces/k/misc/git-relay-server/src/routes/patches.ts`**
...
- [x] Delete `workspaces/k/misc/git-relay-vercel/src/app/api/relay/` directory
