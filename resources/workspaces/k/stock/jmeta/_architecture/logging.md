---
name: "Quarkus Base Logging Guide"
description: "Guide for structured logging in jmeta using KvArg/SA helpers with SLF4J, JSON enrichment, and custom per-type reducers for ReactiveEventAction."
tags: [logging, quarkus, structured-logging, json, architecture]
