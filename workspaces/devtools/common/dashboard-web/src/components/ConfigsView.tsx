                    ...
                    <li key={file.name}>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <FileJson
                            className={`w-3.5 h-3.5 ${isActive ? 'text-blue-400' : 'text-zinc-500 group-hover:text-zinc-400'}`}
                          />
                          {file.name}
                        </div>
                        {isActive && (
                          <ChevronRight className="w-3.5 h-3.5 animate-in slide-in-from-left-2 opacity-70" />
                        )}
                      </button>
                    </li>
                  );
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {!selectedConfig ? (
          <div className="glass-panel rounded-xl flex flex-col items-center justify-center h-full text-zinc-500 gap-4 animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-lg">
              Select a configuration file from the sidebar to edit it.
            </p>
          </div>
        ) : (
