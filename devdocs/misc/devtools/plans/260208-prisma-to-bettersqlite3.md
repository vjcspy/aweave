...
Tất cả Prisma usage nằm gọn trong **1 package**: `devtools/common/nestjs-debate/`.
...
```bash
rm -rf devtools/common/nestjs-debate/prisma/
rm -rf devtools/common/nestjs-debate/generated/
rm    devtools/common/nestjs-debate/src/debate-prisma.service.ts
```
...
Cập nhật `devdocs/misc/devtools/common/nestjs-debate/OVERVIEW.md`:
