...
> See `devdocs/misc/devtools/common/_plans/260207-cli-oclif-refactor.md` for the current architecture.
...
- Debate ecosystem spec: `devdocs/misc/devtools/common/_plans/debate.md`
...
- [ ] Update `devdocs/misc/devtools/common/_plans/debate.md` section 2.3:
