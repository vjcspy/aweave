...
- `devdocs/misc/devtools/common/_plans/debate.md` — Debate spec (nghiệp vụ + hệ thống)
...
Cập nhật `devdocs/misc/devtools/common/_plans/debate.md` section **1.1.5** (Step5) để phản ánh behavior mới:
