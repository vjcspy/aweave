...
- Current debate-server plan: `devdocs/misc/devtools/common/plans/260131-debate-server.md`
...
- [ ] Update `devdocs/misc/devtools/common/plans/debate.md` section 2.8 — reflect new server location and architecture
