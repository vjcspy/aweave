...
```
AGENTS.md (symlink → devdocs/agent/rules/common/rule.md)
...
**Template** (`devdocs/agent/templates/common/create-plan.md`):
...
**Task rule** (`devdocs/agent/rules/common/tasks/create-plan.md`):
...
| - | Debate rules not referenced from main flow | `devdocs/agent/rules/common/debate/` exists but only loaded by commands |
...
| File | Action |
|------|--------|
| `devdocs/agent/rules/common/rule.md` | Added frontmatter, restructured Task Detection, added Context Resolution, updated Execution Flow |
| `devdocs/agent/rules/common/workspaces/business-project.md` | Added FEATURE_NAME, Scope Detection, Search Scope, rewrote Context Loading order |
| `devdocs/agent/rules/common/workspaces/devtools.md` | Added Path Variables, Scope Detection, Search Scope, rewrote Context Loading order |
| `devdocs/agent/rules/common/tasks/create-plan.md` | Added Generation Rules section (moved from template) |
| `devdocs/agent/rules/common/tasks/implementation.md` | Added Change Strategy, Validation Checkpoints, Error Recovery |
| `devdocs/agent/templates/common/create-plan.md` | Cleaned — removed runtime instructions, replaced with HTML comments |
| `devdocs/agent/rules/common/project-structure.md` | Slimmed from 146 → 40 lines, kept directory tree only |
