...
- Lấy order theo `orderSurveys`: `projects/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:54`
- Lấy return theo `returnSurveys`: `projects/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:120`
- Model survey IDs: `projects/tinybots/backend/wonkers-nedap/src/model/Config/SurveyIds.ts:3`
...
Source references:
- FE trigger: `projects/tinybots/frontend/wonkers-dash-admin/src/app/components/orders/overview/SpeedDial/OrderOverviewSpeedDial.tsx:29`
- FE endpoint config: `projects/tinybots/frontend/wonkers-dash-admin/src/app/common/utilities/constants/constants.module.ts:46`
- Admin retrieve endpoint (taas-orders): `projects/tinybots/backend/wonkers-taas-orders/src/App.ts:284`
- Forward sang wonkers-nedap: `projects/tinybots/backend/wonkers-taas-orders/src/service/NedapOnsService.ts:17`
- Retrieve endpoint (wonkers-nedap): `projects/tinybots/backend/wonkers-nedap/src/App.ts:154`
...
- FE reference: `projects/tinybots/frontend/wonkers-dash-admin/src/app/components/orders/overview/redux/api.ts:24`
- Route reference: `projects/tinybots/backend/wonkers-taas-orders/src/App.ts:284`
...
- Service reference: `projects/tinybots/backend/wonkers-taas-orders/src/service/NedapOnsService.ts:17`
- Route reference: `projects/tinybots/backend/wonkers-nedap/src/App.ts:154`
...
References:
- Route registration: `projects/tinybots/backend/wonkers-nedap/src/App.ts:179`
- Controller methods: `projects/tinybots/backend/wonkers-nedap/src/controller/InternalOnsConfigIntegrationController.ts:12`
- Insert/update config data: `projects/tinybots/backend/wonkers-nedap/src/service/OnsIntegrationConfigService.ts:12`
- Persist survey IDs into DB tables (`ons_order_survey`, `ons_return_survey`): `projects/tinybots/backend/wonkers-nedap/src/repository/OnsIntegrationConfigRepository.ts:146`

### 6.3 ONS External APIs (called by wonkers-nedap)

8. `GET /t/survey/surveys/{surveyId}`
- Purpose: Lấy survey definition
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:35`

9. `GET /t/survey/surveys/{surveyId}/survey_results?updated_since=YYYY-MM-DD`
- Purpose: Lấy list survey results theo surveyId
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:50`

10. `GET /t/survey/survey_results/{surveyResultId}`
- Purpose: Lấy full answers của từng result
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:82`

11. `GET /t/clients/{clientId}`
- Purpose: Lấy client metadata
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:149`

12. `GET /t/clients/{clientId}/main_address` (lazy address enrichment)
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:131`

13. `GET /t/employees/{employeeId}` (lazy requester enrichment)
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:97`

14. `GET /t/employees/{employeeId}/teams` (lazy team enrichment)
- Ref: `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:114`
...
- Caller ref: `projects/tinybots/backend/wonkers-nedap/src/service/WonkersTaasOrderService.ts:20`
- Receiver route ref: `projects/tinybots/backend/wonkers-taas-orders/src/App.ts:544`

16. `POST /internal/v1/taas-orders/concepts/returns`
- Purpose: Create return concept
- Caller ref: `projects/tinybots/backend/wonkers-nedap/src/service/WonkersTaasOrderService.ts:31`
- Receiver route ref: `projects/tinybots/backend/wonkers-taas-orders/src/App.ts:291`
...
Ref: `projects/tinybots/backend/wonkers-nedap/src/model/Config/SurveyIds.ts:3`

Runtime behavior:
- Order retrieval chỉ dùng `orderSurveys`: `projects/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:54`
- Return retrieval chỉ dùng `returnSurveys`: `projects/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts:120`
...
- Config ref: `projects/tinybots/backend/wonkers-nedap/config/default.json:30`
- Job function ref: `projects/tinybots/backend/wonkers-nedap/src/App.ts:273`
...
- Log mẫu: `Survey ids: [...]` (được in tại `projects/tinybots/backend/wonkers-nedap/src/api/OnsNedapApi.ts:163`)
