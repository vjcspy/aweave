...
- Repo overview: `devdocs/projects/tinybots/backend/wonkers-nedap/OVERVIEW.md`
- Existing related plan: `devdocs/projects/tinybots/backend/wonkers-nedap/260121-implement-hardware-type-parsing.md`
- Flow documentation: `devdocs/projects/tinybots/backend/wonkers-nedap/Nedap-retrieve-concepts-flow.md`

Code references (current bug location):
- `projects/tinybots/backend/wonkers-nedap/src/mappers/ConceptOrderMapper.ts`
- `projects/tinybots/backend/wonkers-nedap/src/mappers/ConceptReturnMapper.ts`
- `projects/tinybots/backend/wonkers-nedap/src/mappers/mapSurvey.ts`
- `projects/tinybots/backend/wonkers-nedap/src/service/SurveyService.ts`
- `projects/tinybots/backend/wonkers-nedap/test/mappers/ConceptOrderMapperTest.ts`
...
>
> và lưu plan tại `devdocs/projects/tinybots/backend/wonkers-nedap/_plans`.
...
```
projects/tinybots/backend/wonkers-nedap/
├── src/
│   ├── mappers/
